...
<div class="col-lg col-sm-12"></div>
 ...
 <center><h2>Employee reports</h2> </center>
...
$query1=mysqli_query($conn,"select * from employee") or die("selecting error");
                ...
                <tbody id="myTable">
                  ...
                  <td> <?php echo  $row['id'] ?> </td>
                    ...
                    <td> <?php echo "<a href='employee_view.php?id=". $row['id'] ."' title='View Record' data-toggle='tooltip'><span class='glyphicon   text-warning glyphicon-eye-open'></span></a>" ?> </td>
                    
                    <td> <?php echo "<a href='employee_update.php?id=". $row['id'] ."' title='Update Record' data-toggle='tooltip'><span class='glyphicon text-success glyphicon-pencil'></span></a>" ?></td>
                   
                                            
                    <td>  <?php echo "<a href='employee_delete.php?id=". $row['id'] ."' title='Delete Record' data-toggle='tooltip'><span class='glyphicon text-danger glyphicon-trash'></span></a>" ?></td>
