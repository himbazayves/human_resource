...
if($res){
	...
	header( 'Location: employee_transfer.php' ) ;
}else{
...
<div class="container">
	<div class="row">
		...
		<h2>change  Employee's Department</h2>
			<div class="form-group">
			    
			    <div class="col-sm-10">
			      <input type="hidden" name="fname"  class="form-control"  value="<?php echo $r['fname']; ?>" id="input1" placeholder="First Name" />
			    </div>
			</div>
			...
			<div class="form-group">
			    ...
			    <div class="col-sm-10">
			      <input type="hidden"name="lname"  class="form-control"  value="<?php echo $r['lname']; ?>" id="input1" placeholder="Last Name" />
			    </div>
			</div>
			...
			<div class="form-group">
			    ...
			    <div class="col-sm-10">
			      <input type="hidden" name="email"   value="<?php echo $r['email']; ?>" class="form-control" id="input1" placeholder="E-Mail" />
			    </div>
			</div>
			...
			<div class="form-group">
			    ...
			    <div class="col-sm-10">
			      <input type="hidden" name="gender"   value="<?php echo $r['gender']; ?>" class="form-control" id="input1" placeholder="E-Mail" />
			    </div>
			</div>
            ...
            <div class="form-group">
			    ...
			    <div class="col-sm-10">
			      <input type="hidden" name="position" value="<?php echo $r['position']; ?>"   class="form-control" id="input1" placeholder="E-Mail" />
			    </div>
			</div>
            ...
            <div class="form-group">
			    ...
			    <div class="col-sm-10">
			      <input type="hidden"name="username" value="<?php echo $r['username']; ?>"  class="form-control" id="input1" placeholder="E-Mail" />
			    </div>
			</div>
			...
			<div class="form-group">
			    ...
			    <div class="col-sm-10">
			      <input type="hidden" name="password" value="<?php echo $r['password']; ?>"  class="form-control" id="input1" placeholder="E-Mail" />
			    </div>
			</div>
...
?>
            ...
            <div class="form-group">
			    ...
			    <div class="col-sm-10">
			      <input type="hidden" name="phone"  value="<?php echo $r['phone']; ?>"  class="form-control" id="input1" placeholder="E-Mail" />
			    </div>
			</div>

			
			<input type="submit" name="update" class="btn btn-primary col-md-2 col-md-offset-10" value="change" />
		</form>
	</div>
</div>
