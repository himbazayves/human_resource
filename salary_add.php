...
<div class="col-lg col-sm-12"></div>
 ...
 <center><h2>Select employee</h2> </center>
...
$query1=mysqli_query($conn,"select * from salary,employee where salary.id=employee.id") or die("selecting error");
                ...
                <tbody id="myTable">
                  ...
                  <td> <?php echo  $row['id'] ;?> </td>
                    ...
                    <td>
                    <?php if ($row['salary'] ==0) :   ?> 
                    <span class="label label-danger">NO SALARY</span>
                    <?php else :   ?>
                    
                    <?php echo $row['salary'];?>FRW
                    ...
                    <td>
                     ...
                     <?php echo "<a href='new_salary.php?id=". $row['id'] ."' title='Update Record' data-toggle='tooltip' class='btn btn-success'> Create Salary</a>" ?></td>

                   
                   
                     <?php else :   ?>
                     <?php echo "<a href='new_salary.php?id=". $row['id'] ."' title='Update Record' data-toggle='tooltip' class='btn btn-danger'> Edit Salary</a>" ?></td>
