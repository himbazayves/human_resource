...
if(isset($_POST["id"]) && !empty($_POST["id"])){
    ...
    $qry=$link->query("UPDATE  `human_ressource`.`working_history` SET end_date='$end_date'");
...
if($qry)
{
    ...
    if($stmt = mysqli_prepare($link, $sql)){
        ...
        if(mysqli_stmt_execute($stmt)){
            ...
            $qry1=$link->query( "DELETE FROM salary WHERE salary.id = ?");
                    ...
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                        <div class="alert alert-danger fade in">
                            ...
                            <p>
                                ...
                                <a href="employee_report.php" class="btn btn-default">No</a>
                            </p>
                        </div>
                    </form>
                </div>
